...
# this if statement basically tells Python to do this first if we're running it from the command line
if __name__ == "__main__":
    # echo just spits back all the arguments as a singular string
    # so what would you need to do here for that to happen?
    # remember that echo doesn't include itself in all that it prints to stdout
