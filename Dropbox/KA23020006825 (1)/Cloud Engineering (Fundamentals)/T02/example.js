...
// the variable myObject is assigned the object {color: "blue", time: "8pm"} due to the presence of curly brackets ({...})


// ============ Example 5 ============
let numberString = "10";
//Watch out! Since you defined 10 within quotation marks, JavaScript knows this is a string. It's not an integer even though we understand 10 is a number.
...
let total = num4+num5;
console.log(total);             // Added numbers together
...
console.log(total -1); // Returns false because total - 1 = 0
